...
import com.eliteinfo.wallpaper.R;
 ...
 */
public class ActPurchase extends Activity implements IabBroadcastListener,
        OnClickListener {
    ...
    static final String SKU_GAS = "product_custom_0001";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(ActPurchase.this);
